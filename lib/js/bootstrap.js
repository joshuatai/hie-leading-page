...
/* ============================================================
 * tm-bootstrap-tooltip.js v1.0.1
...
!function ($) {
	...
	// save the original function object
	var _super = $.fn.tooltip
    , Tooltip = _super.Constructor;
    
	// extend prototypes
	Tooltip.prototype = $.extend({}, _super.Constructor.prototype, {
    hide: function () {
      var that = this
        , $tip = this.tip()
        , e = $.Event('hide')
...
/* ========================================================
 * bootstrap-validation.js v2.3.1
 * http://twitter.github.com/bootstrap/javascript.html#validations
 * ======================================================== */
